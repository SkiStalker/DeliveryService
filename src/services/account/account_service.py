...
SECRET_KEY = os.environ.get("JWT_SECRET_KEY", "")
...
def create_token(user_id: str,  permissions: set[str], refresh_token: bool = False):
    if refresh_token:
        return create_jwt_token({"sub": user_id, "permissions": [*permissions]}, timedelta(days=REFRESH_TOKEN_EXPIRE_DAYS))
    else:
        return create_jwt_token({"sub": user_id, "permissions": [*permissions]}, timedelta(minutes=ACCESS_TOKEN_EXPIRE_MINUTES))
...
class AccountService(AccountServiceServicer):
    ...
    async def Refresh(self, request: RefreshRequest, context: ServicerContext) -> RefreshResponse:
